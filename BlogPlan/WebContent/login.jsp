            ...
            <div class="login-wrapper">
                ...
                <div id="myTabContent" class="tab-content bn">
                    <div class="tab-pane fade active in" id="log-in">
                        ...
                        <form class="form-horizontal mt10" action="/BlogPlan/new/login_function" method="post" id="login-form" role="form">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <input type="text" name="login_user.loginEmail" id="email" class="form-control left-icon" value="" placeholder="Your email ...">
                                    <i class="ec-user s16 left-input-icon"></i>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <input type="password" name="login_user.loginPwd" id="password" class="form-control left-icon" value="" placeholder="Your password">
